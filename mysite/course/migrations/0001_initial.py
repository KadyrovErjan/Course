    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('client', 'client'), ('teacher', 'teacher'), ('administrator', 'administrator')], default='teacher', max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='course_list', to='course.category')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name_exam_ky', models.CharField(max_length=32, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name_lesson_ky', models.CharField(max_length=32, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('answers_ky', models.CharField(max_length=64, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name_assignment_ky', models.CharField(max_length=32, null=True)),
                ('description', models.TextField()),
                ('description_en', models.TextField(null=True)),
                ('description_ru', models.TextField(null=True)),
                ('description_ky', models.TextField(null=True)),
                ...
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='course.course')),
                ('students', models.ManyToManyField(related_name='students', to='course.student')),
            ],
        ),
    ]
